...
colnames(df_logit_1) <- c("Model", "F1_Score")
colnames(df_logit_1_best_threshold) <- c("Model", "F1_Score")
colnames(df_Logit_prec_recall) <- c("Model", "F1_Score")
colnames(df_reponderar_obs) <- c("Model", "F1_Score")
colnames(df_logit_down_sampling) <- c("Model", "F1_Score")
colnames(df_logit_upsampled) <- c("Model", "F1_Score")
